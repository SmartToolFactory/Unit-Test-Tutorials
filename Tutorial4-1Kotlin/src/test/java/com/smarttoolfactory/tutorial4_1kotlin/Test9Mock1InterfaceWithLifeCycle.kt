...
class Test9Mock1InterfaceWithLifeCycle {


    private val studentUseCase: StudentUseCase

    private val studentDataSource: StudentDataSource = mock(StudentDataSource::class.java)

    init {
        studentUseCase = StudentUseCase(studentDataSource)
    }

    @BeforeEach
    fun setUp() {
        Mockito.reset(studentDataSource)
    }
